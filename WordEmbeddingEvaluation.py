...
def process(filename, token_to_vector_map):
    ...
    with open(filename, encoding="utf8") as f:
        ...
        for str in f.readlines():
            ...
            #else:
            #    print("Input: ", first, second, third, fourth)
            #    print("Predicted: ", wordWithMaxCosineSimilarity)
...
if __name__ == "__main__":
    ...
    token_to_vector_map = parse_word_file("analogy_test.txt", model)
...
'''
    ...
    token_to_vector_map = parse_word_file("custom_test1.txt", model)
    process("custom_test1.txt", token_to_vector_map)

    token_to_vector_map = parse_word_file("custom_test2.txt", model)
    process("custom_test2.txt", token_to_vector_map)

    token_to_vector_map = parse_word_file("custom_test3.txt", model)
    process("custom_test3.txt", token_to_vector_map)
'''